              ...
              <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-center" id="navbarButtons">
                  <div class="d-flex mx-auto gap-3">
                   <a href="/final exam/home.html"><button class="btn btn-warning me-2" id="home" type="button">Home</button></a> 
                   <a href="/final exam/pages/Add_ques.html"> <button class="btn btn-warning" id="addData" type="button">Add Question</button></a>
                  </div>
                </div>
              </div>
            </nav>
